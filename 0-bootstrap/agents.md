...
- In shared inboxes, treat `6-raw/inbox/new/` and legacy direct inbox folders as unprocessed input; move claimed batches through processing states and never delete raw inputs before a retrieval receipt exists.
