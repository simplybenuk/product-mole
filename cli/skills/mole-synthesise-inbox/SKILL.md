...
1. Read `0-bootstrap/`, `1-routing/`, relevant summaries/indexes, and inspect the current `6-raw/inbox/` contents.
...
5. Update `3-indexes/` or `2-summaries/` only if the new signal materially changes higher-level context. Update `2-summaries/user-summary.md` when persona changes materially affect user understanding.
6. Add missing human questions to `governance/input-queue.md` if important decisions cannot be made from the available context.
7. Report what was synthesised, what personas were created or updated, what other files changed, and what still needs human input.
