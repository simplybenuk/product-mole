...
- agent involvement already happening in the repo/workspace
...
## Early use cases for WCCRM
- auth and registration strategy
- release/versioning planning
- product/spec drafting
- implementation decision records
- PM/agent shared planning context

## Recommendation

Treat WCCRM as an early adopter instance once the scaffold/command flow is slightly more mature.
That should be enough to prove whether the system is genuinely useful beyond theory.
